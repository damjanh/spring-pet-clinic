...
public class OwnersController {
    ...
    @GetMapping("/new")
    public String showCrationForm(Model model) {
        model.addAttribute("owner", Owner.builder().build());
    ...
    public String showUpdateOwnerForm(@PathVariable("ownerId") Long ownerId, Model model) {
    ...
    public String processUpdateOnwerForm(
            @Valid Owner owner,
